...
class CaptioningSolver(object):
    ...
    def __init__(self, model, data, **kwargs):
        ...
        # 训练超参数都通过 kwargs 传进来，solver 负责统一保存和调度。
        ...
        # update_rule 一开始是字符串，这里映射成 optim.py 里的真实函数对象。
    ...
    def _reset(self):
        ...
        # 每个参数都维护自己的一份优化器状态，比如 momentum / cache / Adam 的 m,v。
        self.optim_configs = {}
    ...
    def train(self):
        ...
        # iterations_per_epoch 表示把整个训练集大致扫一遍需要多少个 step。
